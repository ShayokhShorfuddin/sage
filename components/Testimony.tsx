	...
	return (
		<section className="flex flex-col sm:flex-row gap-x-10 gap-y-10 justify-between mx-[1rem] sm:mx-[2rem] mt-[6rem]">
			...
			<div>
				...
				<p className="text-2xl text-neutral-400 leading-normal max-w-[30rem] mt-5">
			...
			<div className="max-w-xs">
				<p className="text-neutral-200 text-4xl font-bold">92%</p>
				<p className="text-lg text-neutral-500 mt-3">
					of ours users have found our platform helpful in their job search.
				</p>

				<div className="h-[0.5px] w-full bg-neutral-800 mt-6" />

				<p className="text-neutral-200 text-4xl font-bold mt-6">97%</p>
				<p className="text-lg text-neutral-500 mt-3">
					of ours users have recommended our platform to their peers.
				</p>
			</div>
		</section>
	);
